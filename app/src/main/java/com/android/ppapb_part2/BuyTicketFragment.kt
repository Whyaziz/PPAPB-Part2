...
import com.android.ppapb_part2.databinding.FragmentBuyTicketBinding
...
class BuyTicketFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val selectedTicketType = sharedViewModel.selectedTicketType
        binding.txtJenisTiket.text = selectedTicketType
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            txtJenisTiket.setOnClickListener{
                val action = BuyTicketFragmentDirections.actionBuyTicketFragmentToSpinnerFragment()
